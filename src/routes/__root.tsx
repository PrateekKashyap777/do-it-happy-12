  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        <h1 className="text-6xl font-mono font-semibold text-accent">404</h1>
        <h2 className="mt-4 text-xl font-semibold">Page not found</h2>
        <p className="mt-2 text-sm text-muted-foreground">
          That coordinate does not exist on the map.
        </p>
        <a
          href="/"
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Terrain — Market Intelligence" },
      { name: "description", content: "Weekly market intelligence briefs for real estate operators." },
    ],
    links: [
